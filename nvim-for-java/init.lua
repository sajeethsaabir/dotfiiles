...
-- Load the options from the confin.options.lua & keymaps.lua files
...
-- Setup Lazy, this should always be last[Pro Tip]
-- Tell Lazy that all plugins are found in the plugins directory
-- Pass it the option we specified above
